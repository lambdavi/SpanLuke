...
if __name__ == "__main__":
    ...
    if not use_span:
        ...
        ## Collator
        data_collator = DataCollatorForTokenClassification(train_ds.tokenizer) if dataset != "ener" else DataCollatorForTokenClassification(tokenizer=data_processor.tokenizer)
